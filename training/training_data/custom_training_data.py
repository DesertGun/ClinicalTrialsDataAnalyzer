...
train_data_init = [
    ...
    ('Time to pre-visit PROMIS form completion|PROMIS form completion rates according to patient demographics',
        {'entities': [(83, 103, 'Reference'), (0, 24, 'Variable')]}),
    ('AUC from time 0 and extrapolated to infinite time, total exposure(AUCinf)|AUC from time 0 to the last non-zero concentration(AUClast)|Maximum observed concentration (Cmax)|Time at which Cmax was first observed(Tmax)|half life（T½）|Apparent total systemic clearance, calculated as Dose/AUCinf(Cl/F)|Apparent volume of distribution(Vd/F)|elimination rate constant（Kel）',
     {'entities': [(9, 13, 'Reference'), (36, 49, 'Reference'), (83, 87, 'Reference'), (0, 3, 'Change')]}),
    ('Time to pre-visit PROMIS form completion|PROMIS form completion rates according to patient demographics',
     {'entities': [(83, 103, 'Reference'), (0, 24, 'Variable')]}),
    ('Health Belief Model Scale in Obesity ((questionnaire-scale)|Health Belief Model Scale in Obesity-Importance of Health (questionnaire-scale)|Health Belief Model Scale in Obesity- Perceived sensitivity (questionnaire-scale)|Health Belief Model Scale in Obesity- Perceived severity (questionnaire-scale)|Health Belief Model Scale in Obesity- Perceived benefit (questionnaire-scale)|Health Belief Model Scale in Obesity- Perceived barrier (questionnaire-scale)|Height Meter|weighing machine|body mass index calculation',
     {'entities': [(29, 36, 'Condition'), (89, 96, 'Condition'), (0, 25, 'Reference'), (97, 117, 'Reference'), (178, 199, 'Reference'), (260, 278, 'Reference'), (339, 356, 'Reference'), (417, 434, 'Reference')]}),
     ...
     ('Puffs/day', {'entities': [(0, 9, 'Change')]}), 
     ('Percent pacing', {'entities': [(0, 14, 'Change')]}), 
     ('(cells*10^9)*h', {'entities': [(0, 14, 'Change')]}), 
     ...
     ('ng*h/mL/[mg]', {'entities': [(0, 12, 'Change')]}), 
     ('Micromoles (umol)/L', {'entities': [(0, 19, 'Change')]}), 
     ('µV*msec', {'entities': [(0, 7, 'Change')]}), 
     ('blood smears', {'entities': [(0, 12, 'Reference')]}), 
     ('(mg/dl)*minutes', {'entities': [(0, 15, 'Change')]}), 
     ('liter(L)/hr', {'entities': [(0, 11, 'Change')]}), 
     ('pmole/L', {'entities': [(0, 7, 'Change')]}), 
     ('ml/s/100g', {'entities': [(0, 9, 'Change')]}), 
     ...
     ('Invasive Mycosis', {'entities': [(0, 16, 'Condition')]}), 
     ('Cervical Lymphadenopathy', {'entities': [(0, 24, 'Condition')]}), 
     ('Behavior, Sedentary', {'entities': [(0, 8, 'Reference'), (10, 19, 'Reference')]})
]
